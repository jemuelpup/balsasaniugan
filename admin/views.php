...
function selectTransactionsBetweenDate($c,$d){
	$sql = "SELECT
		...
		ol.name as oLine_name, ol.code as oLine_code,
		...
		o.vat,
		o.service_charge
		FROM order_tbl o, order_line_tbl ol  WHERE o.id = ol.order_id_fk AND o.payment > 0 AND o.done=1 AND o.received_date BETWEEN '".substr($d->from,0,10)."' AND '".substr($d->to,0,10)."'"." order by o.id";
	// echo $sql;
